/* Biences Design Review v0.32.0 — standalone (coller dans la console devtools). */
...
(async function () {
  ...
  function exportJSON() {
    var payload = {
      tool: 'biences-design-review', version: '0.32.0',
  ...
  console.log('[BDR] v0.32.0 prêt — en pause, ' + feedbacks.length + ' modif(s) en mémoire. Onglet « ◀ Design Review » sur le bord GAUCHE (à mi-hauteur), ou Alt+R.');
})();
